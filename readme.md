...
|------------|---------------------------------------------|----------------|-----------------------------------------------------------------------------------------|
| Luka       | Estilización y diseño web, redacción README | 13 horas       | Encargado de la estilización del HTML , CSS y Javascript, asegurando una apariencia clara y organizada. Desarrollo y optimización de los botones en la interfaz web. Redacción de parte del README. |
